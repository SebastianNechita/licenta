...
# maxObjectsRange = [50]
maxAgeRange = None
maxObjectsRange = None
# videosList = [ ("caltech", "set03", "V000"), ("caltech" , "set01", "V005"), ("caltech", "set01", "V000")]
# videosList = [("caltech", "set01", "V004")]
videosList = [("caltech", "set03", "V011")]
# videosList = None
# videosList = service.getTrainingVideoList()
stepSize = 0.2
# service.playVideo(("caltech", "set03", "V009"), config)
service.optimizeTrackerConfig(config, "a.txt", trackerTypes, ctRange, rtRange, stRange, smpRange, mspRange, videosList, None, 150, True, stepSize, maxAgeRange, maxObjectsRange)
